...
function cards() {
  ...
  class MenuCard {
    ...
    render() {
      ...
      //Применение параметра по умолчанию на случай, если в аргументы не передан класс
...
function slider({
  ...
  indicators.classList.add('carousel-inidcators');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2021-11-28');
